...
function quickselect(array8, k2, left2 = 0, right2 = Infinity, compare) {
  ...
  if (!(left2 <= k2 && k2 <= right2)) return array8;
  ...
  while (right2 > left2) {
    ...
    if (compare(array8[right2], t) > 0) swap(array8, left2, right2);
    while (i < j) {
      swap(array8, i, j), ++i, --j;
      while (compare(array8[i], t) < 0) ++i;
      while (compare(array8[j], t) > 0) --j;
    }
    if (compare(array8[left2], t) === 0) swap(array8, left2, j);
    else ++j, swap(array8, j, right2);
    if (j <= k2) left2 = j + 1;
    if (k2 <= j) right2 = j - 1;
  }
  return array8;
...
function axis(orient, scale2) {
  ...
  function axis2(context) {
    ...
    selection6.filter(entering).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", orient === right ? "start" : orient === left ? "end" : "middle");
    selection6.each(function() {
...
function EnterNode(parent, datum6) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
  this.__data__ = datum6;
}
EnterNode.prototype = {
...
function merge_default(context) {
  var selection6 = context.selection ? context.selection() : context;
  for (var groups0 = this._groups, groups1 = selection6._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
...
function nodrag_default(view) {
  var root7 = view.document.documentElement, selection6 = select_default2(view).on("dragstart.drag", noevent_default, nonpassivecapture);
  if ("onselectstart" in root7) {
    selection6.on("selectstart.drag", noevent_default, nonpassivecapture);
  } else {
...
function yesdrag(view, noclick) {
  var root7 = view.document.documentElement, selection6 = select_default2(view).on("dragstart.drag", null);
  if (noclick) {
    selection6.on("click.drag", noevent_default, nonpassivecapture);
    setTimeout(function() {
      selection6.on("click.drag", null);
    }, 0);
  }
  if ("onselectstart" in root7) {
    selection6.on("selectstart.drag", null);
  } else {
...
function drag_default() {
  ...
  function drag(selection6) {
    selection6.on("mousedown.drag", mousedowned).filter(touchable).on("touchstart.drag", touchstarted).on("touchmove.drag", touchmoved, nonpassive).on("touchend.drag touchcancel.drag", touchended).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
...
function EnterNode2(parent, datum6) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
// node_modules/d3-transition/node_modules/d3-selection/src/namespaces.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/namespace.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/creator.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selector.js
function none3() {
}
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/select.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/array.js
function array4(x4) {
  return x4 == null ? [] : Array.isArray(x4) ? x4 : Array.from(x4);
}

// node_modules/d3-transition/node_modules/d3-selection/src/selectorAll.js
function empty4() {
  return [];
}
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/selectAll.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/matcher.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/selectChild.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/selectChildren.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/filter.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/sparse.js
function sparse_default3(update) {
  return new Array(update.length);
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/enter.js
function enter_default3() {
  return new Selection3(this._enter || this._groups.map(sparse_default3), this._parents);
}
function EnterNode3(parent, datum6) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
// node_modules/d3-transition/node_modules/d3-selection/src/constant.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/data.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/exit.js
function exit_default3() {
  return new Selection3(this._exit || this._groups.map(sparse_default3), this._parents);
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/join.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/merge.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/order.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/sort.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/call.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/nodes.js
function nodes_default3() {
  return Array.from(this);
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/node.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/size.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/empty.js
function empty_default3() {
  return !this.node();
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/each.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/attr.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/window.js
function window_default3(node) {
  return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/style.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/property.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/classed.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/text.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/html.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/raise.js
function raise3() {
  if (this.nextSibling) this.parentNode.appendChild(this);
}
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/lower.js
function lower3() {
  if (this.previousSibling) this.parentNode.insertBefore(this, this.parentNode.firstChild);
}
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/append.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/insert.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/remove.js
function remove3() {
  var parent = this.parentNode;
  if (parent) parent.removeChild(this);
}
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/clone.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/datum.js
function datum_default3(value) {
  return arguments.length ? this.property("__data__", value) : this.node().__data__;
}

// node_modules/d3-transition/node_modules/d3-selection/src/selection/on.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/dispatch.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/iterator.js
...
// node_modules/d3-transition/node_modules/d3-selection/src/selection/index.js
var root3 = [null];
...
// node_modules/d3-transition/node_modules/d3-selection/src/local.js
var nextId3 = 0;
function local3() {
  return new Local3();
}
...
function selectAll_default7(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children6 = select.call(node, node.__data__, i, group2), child, inherit2 = get2(node, id2), k2 = 0, l = children6.length; k2 < l; ++k2) {
          if (child = children6[k2]) {
            schedule_default(child, name, id2, k2, children6, inherit2);
          }
        }
        subgroups.push(children6);
        parents.push(node);
      }
    }
  }
...
function styleMaybeRemove(id2, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove6;
  return function() {
    var schedule = set3(this, id2), on = schedule.on, listener = schedule.value[key] == null ? remove6 || (remove6 = styleRemove4(name)) : void 0;
...
function BrushEvent(type2, {
  ...
  Object.defineProperties(this, {
    ...
    sourceEvent: { value: sourceEvent, enumerable: true, configurable: true },
    target: { value: target, enumerable: true, configurable: true },
    selection: { value: selection6, enumerable: true, configurable: true },
...
function brush(dim) {
  var extent2 = defaultExtent, filter7 = defaultFilter2, touchable = defaultTouchable2, keys = true, listeners = dispatch_default("start", "brush", "end"), handleSize = 6, touchending;
  function brush2(group2) {
    ...
    overlay.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", cursors.overlay).merge(overlay).each(function() {
      var extent3 = local4(this).extent;
  ...
  brush2.move = function(group2, selection6, event) {
    if (group2.tween) {
      group2.on("start.brush", function(event2) {
        ...
        var that = this, state = that.__brush, emit = emitter(that, arguments), selection0 = state.selection, selection1 = dim.input(typeof selection6 === "function" ? selection6.apply(this, arguments) : selection6, state.extent), i = value_default(selection0, selection1);
        function tween(t) {
      ...
      group2.each(function() {
        var that = this, args = arguments, state = that.__brush, selection1 = dim.input(typeof selection6 === "function" ? selection6.apply(that, args) : selection6, state.extent), emit = emitter(that, args).beforestart();
  ...
  function redraw() {
    var group2 = select_default4(this), selection6 = local4(this).selection;
    if (selection6) {
      group2.selectAll(".selection").style("display", null).attr("x", selection6[0][0]).attr("y", selection6[0][1]).attr("width", selection6[1][0] - selection6[0][0]).attr("height", selection6[1][1] - selection6[0][1]);
      group2.selectAll(".handle").style("display", null).attr("x", function(d) {
        return d.type[d.type.length - 1] === "e" ? selection6[1][0] - handleSize / 2 : selection6[0][0] - handleSize / 2;
      }).attr("y", function(d) {
        return d.type[0] === "s" ? selection6[1][1] - handleSize / 2 : selection6[0][1] - handleSize / 2;
      }).attr("width", function(d) {
        return d.type === "n" || d.type === "s" ? selection6[1][0] - selection6[0][0] + handleSize : handleSize;
      }).attr("height", function(d) {
        return d.type === "e" || d.type === "w" ? selection6[1][1] - selection6[0][1] + handleSize : handleSize;
      });
    } else {
  ...
  function started(event) {
    ...
    var that = this, type2 = event.target.__data__.type, mode2 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local4(that), extent3 = state.extent, selection6 = state.selection, W = extent3[0][0], w0, w1, N = extent3[0][1], n0, n1, E2 = extent3[1][0], e0, e1, S = extent3[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
    ...
    if (type2 === "overlay") {
      if (selection6) moving = true;
      const pts = [points[0], points[1] || points[0]];
      state.selection = selection6 = [[
    ...
    function move(event2) {
      ...
      if (state.selection) selection6 = state.selection;
      if (lockX) w1 = selection6[0][0], e1 = selection6[1][0];
      if (lockY) n1 = selection6[0][1], s1 = selection6[1][1];
      if (selection6[0][0] !== w1 || selection6[0][1] !== n1 || selection6[1][0] !== e1 || selection6[1][1] !== s1) {
    ...
    function ended(event2) {
      ...
      if (state.selection) selection6 = state.selection;
      if (empty5(selection6)) state.selection = null, redraw.call(that);
  ...
  brush2.filter = function(_) {
    return arguments.length ? (filter7 = typeof _ === "function" ? _ : constant_default6(!!_), brush2) : filter7;
  };
...
function contours_default() {
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default8(slice3.call(_)) : constant_default8(_), contours) : threshold2;
  };
...
function density_default() {
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold2 = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default8(slice3.call(_)) : constant_default8(_), density) : threshold2;
  };
...
function collide_default(radius) {
  ...
  if (typeof radius !== "function") radius = constant_default9(radius == null ? 1 : +radius);
  function force() {
...
function x_default2(x4) {
  ...
  if (typeof x4 !== "function") x4 = constant_default9(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function y_default2(y4) {
  ...
  if (typeof y4 !== "function") y4 = constant_default9(y4 == null ? 0 : +y4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function meanX(children6) {
  return children6.reduce(meanXReduce, 0) / children6.length;
}
function meanXReduce(x4, c6) {
  return x4 + c6.x;
}
function maxY(children6) {
  return 1 + children6.reduce(maxYReduce, 0);
}
...
function leafLeft(node) {
  var children6;
  while (children6 = node.children) node = children6[0];
  return node;
}
function leafRight(node) {
  var children6;
  while (children6 = node.children) node = children6[children6.length - 1];
  return node;
}
function cluster_default() {
  ...
  function cluster(root7) {
    ...
    root7.eachAfter(function(node) {
      var children6 = node.children;
      if (children6) {
        node.x = meanX(children6);
        node.y = maxY(children6);
      } else {
    ...
    var left2 = leafLeft(root7), right2 = leafRight(root7), x06 = left2.x - separation(left2, right2) / 2, x12 = right2.x + separation(right2, left2) / 2;
    return root7.eachAfter(nodeSize ? function(node) {
      node.x = (node.x - root7.x) * dx;
      node.y = (root7.y - node.y) * dy;
    } : function(node) {
      node.x = (node.x - x06) / (x12 - x06) * dx;
      node.y = (1 - (root7.y ? node.y / root7.y : 1)) * dy;
    });
  }
...
function count2(node) {
  var sum4 = 0, children6 = node.children, i = children6 && children6.length;
  if (!i) sum4 = 1;
  else while (--i >= 0) sum4 += children6[i].value;
  node.value = sum4;
}
...
function eachBefore_default(callback, that) {
  var node = this, nodes = [node], children6, i, index3 = -1;
  while (node = nodes.pop()) {
    callback.call(that, node, ++index3, this);
    if (children6 = node.children) {
      for (i = children6.length - 1; i >= 0; --i) {
        nodes.push(children6[i]);
      }
    }
  }
  return this;
...
function eachAfter_default(callback, that) {
  var node = this, nodes = [node], next = [], children6, i, n, index3 = -1;
  while (node = nodes.pop()) {
    next.push(node);
    if (children6 = node.children) {
      for (i = 0, n = children6.length; i < n; ++i) {
        nodes.push(children6[i]);
      }
    }
  }
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum4 = +value(node.data) || 0, children6 = node.children, i = children6 && children6.length;
    while (--i >= 0) sum4 += children6[i].value;
    node.value = sum4;
  });
}
...
function links_default() {
  var root7 = this, links = [];
  root7.each(function(node) {
    if (node !== root7) {
...
function* iterator_default4() {
  var node = this, current, next = [node], children6, i, n;
  do {
...
function hierarchy(data, children6) {
  if (data instanceof Map) {
    data = [void 0, data];
    if (children6 === void 0) children6 = mapChildren;
  } else if (children6 === void 0) {
    children6 = objectChildren;
  }
  var root7 = new Node(data), node, nodes = [root7], child, childs, i, n;
  while (node = nodes.pop()) {
    if ((childs = children6(node.data)) && (n = (childs = Array.from(childs)).length)) {
...
function pack_default() {
  ...
  function pack(root7) {
    ...
    if (radius) {
      root7.eachBefore(radiusLeaf(radius)).eachAfter(packChildrenRandom(padding, 0.5, random)).eachBefore(translateChild(1));
    } else {
      root7.eachBefore(radiusLeaf(defaultRadius2)).eachAfter(packChildrenRandom(constantZero, 1, random)).eachAfter(packChildrenRandom(padding, root7.r / Math.min(dx, dy), random)).eachBefore(translateChild(Math.min(dx, dy) / (2 * root7.r)));
    }
    return root7;
  }
...
function packChildrenRandom(padding, k2, random) {
  return function(node) {
    if (children6 = node.children) {
      var children6, i, n = children6.length, r = padding(node) * k2 || 0, e;
      if (r) for (i = 0; i < n; ++i) children6[i].r += r;
      e = packSiblingsRandom(children6, random);
      if (r) for (i = 0; i < n; ++i) children6[i].r -= r;
      node.r = e + r;
    }
  };
...
function partition_default() {
  ...
  function partition(root7) {
    ...
    root7.x0 = root7.y0 = padding;
    root7.x1 = dx;
    root7.y1 = dy / n;
    root7.eachBefore(positionNode(dy, n));
    if (round) root7.eachBefore(round_default2);
    return root7;
  }
...
function stratify_default() {
  ...
  function stratify(data) {
    var nodes = Array.from(data), currentId = id2, currentParentId = parentId, n, d, i, root7, parent, node, nodeId, nodeKey, nodeByKey = /* @__PURE__ */ new Map();
    if (path2 != null) {
    ...
    for (i = 0; i < n; ++i) {
      ...
      if (nodeId = node.parent) {
        ...
        if (root7) throw new Error("multiple roots");
        root7 = node;
      }
    }
    if (!root7) throw new Error("no root");
    if (path2 != null) {
      while (root7.data === imputed && root7.children.length === 1) {
        root7 = root7.children[0], --n;
      }
...
function nextLeft(v2) {
  var children6 = v2.children;
  return children6 ? children6[0] : v2.t;
}
function nextRight(v2) {
  var children6 = v2.children;
  return children6 ? children6[children6.length - 1] : v2.t;
}
...
function executeShifts(v2) {
  var shift = 0, change = 0, children6 = v2.children, i = children6.length, w;
  while (--i >= 0) {
    w = children6[i];
    w.z += shift;
    w.m += shift;
...
function treeRoot(root7) {
  var tree = new TreeNode(root7, 0), node, nodes = [tree], child, children6, i, n;
  while (node = nodes.pop()) {
    if (children6 = node._.children) {
      node.children = new Array(n = children6.length);
      for (i = n - 1; i >= 0; --i) {
        nodes.push(child = node.children[i] = new TreeNode(children6[i], i));
        child.parent = node;
      }
    }
  }
...
function tree_default() {
  ...
  function tree(root7) {
    ...
    if (nodeSize) root7.eachBefore(sizeNode);
    else {
      var left2 = root7, right2 = root7, bottom2 = root7;
      root7.eachBefore(function(node) {
  ...
  function firstWalk(v2) {
    var children6 = v2.children, siblings = v2.parent.children, w = v2.i ? siblings[v2.i - 1] : null;
    if (children6) {
      executeShifts(v2);
      var midpoint = (children6[0].z + children6[children6.length - 1].z) / 2;
      if (w) {
...
function EnterNode4(parent, datum6) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
function bindIndex4(parent, group2, enter, update, exit, data) {
  var i = 0, node, groupLength = group2.length, dataLength = data.length;
  for (; i < dataLength; ++i) {
    if (node = group2[i]) {
      node.__data__ = data[i];
...
function bindKey4(parent, group2, enter, update, exit, data, key) {
  var i, node, nodeByKeyValue = /* @__PURE__ */ new Map(), groupLength = group2.length, dataLength = data.length, keyValues = new Array(groupLength), keyValue;
  for (i = 0; i < groupLength; ++i) {
    if (node = group2[i]) {
      keyValues[i] = keyValue = key.call(node, node.__data__, i, group2) + "";
...
function data_default5(value, key) {
  ...
  var bind = key ? bindKey4 : bindIndex4, parents = this._parents, groups2 = this._groups;
  if (typeof value !== "function") value = constant_default12(value);
  for (var m3 = groups2.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group2 = groups2[j], groupLength = group2.length, data = arraylike4(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group2, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1) i1 = i0 + 1;
...
function selectAll_default9(selector) {
  return typeof selector === "string" ? new Selection5([document.querySelectorAll(selector)], [document.documentElement]) : new Selection5([array6(selector)], root5);
}
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort2 = null, startAngle = constant_default13(0), endAngle = constant_default13(tau6), padAngle = constant_default13(0);
  function pie(data) {
...
var xhtml5 = "http://www.w3.org/1999/xhtml";
var namespaces_default5 = {
  svg: "http://www.w3.org/2000/svg",
  xhtml: xhtml5,
  xlink: "http://www.w3.org/1999/xlink",
  xml: "http://www.w3.org/XML/1998/namespace",
...
function namespace_default5(name) {
  var prefix = name += "", i = prefix.indexOf(":");
  if (i >= 0 && (prefix = name.slice(0, i)) !== "xmlns") name = name.slice(i + 1);
  return namespaces_default5.hasOwnProperty(prefix) ? { space: namespaces_default5[prefix], local: name } : name;
}

// node_modules/d3-zoom/node_modules/d3-selection/src/creator.js
function creatorInherit5(name) {
  return function() {
    var document2 = this.ownerDocument, uri = this.namespaceURI;
    return uri === xhtml5 && document2.documentElement.namespaceURI === xhtml5 ? document2.createElement(name) : document2.createElementNS(uri, name);
  };
}
function creatorFixed5(fullname) {
  return function() {
    return this.ownerDocument.createElementNS(fullname.space, fullname.local);
  };
}
function creator_default5(name) {
  var fullname = namespace_default5(name);
  return (fullname.local ? creatorFixed5 : creatorInherit5)(fullname);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selector.js
function none5() {
}
function selector_default5(selector) {
...
function select_default10(select) {
  if (typeof select !== "function") select = selector_default5(select);
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = new Array(m3), j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
      if ((node = group2[i]) && (subnode = select.call(node, node.__data__, i, group2))) {
        if ("__data__" in node) subnode.__data__ = node.__data__;
  ...
  return new Selection6(subgroups, this._parents);
}
...
function selectorAll_default5(selector) {
...
function arrayAll5(select) {
  return function() {
    return array7(select.apply(this, arguments));
  };
}
function selectAll_default10(select) {
  if (typeof select === "function") select = arrayAll5(select);
  else select = selectorAll_default5(select);
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        subgroups.push(select.call(node, node.__data__, i, group2));
  ...
  return new Selection6(subgroups, parents);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/matcher.js
function matcher_default5(selector) {
  return function() {
    return this.matches(selector);
  };
}
function childMatcher5(selector) {
  return function(node) {
    return node.matches(selector);
  };
}
...
var find6 = Array.prototype.find;
function childFind5(match) {
  return function() {
    return find6.call(this.children, match);
  };
}
function childFirst5() {
  return this.firstElementChild;
}
function selectChild_default5(match) {
  return this.select(match == null ? childFirst5 : childFind5(typeof match === "function" ? match : childMatcher5(match)));
}
...
function childrenFilter5(match) {
  return function() {
    return filter6.call(this.children, match);
  };
}
function selectChildren_default5(match) {
  return this.selectAll(match == null ? children5 : childrenFilter5(typeof match === "function" ? match : childMatcher5(match)));
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/filter.js
function filter_default6(match) {
  if (typeof match !== "function") match = matcher_default5(match);
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = new Array(m3), j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) {
      if ((node = group2[i]) && match.call(node, node.__data__, i, group2)) {
        subgroup.push(node);
...
function sparse_default5(update) {
  return new Array(update.length);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/enter.js
function enter_default5() {
  return new Selection6(this._enter || this._groups.map(sparse_default5), this._parents);
}
function EnterNode5(parent, datum6) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
EnterNode5.prototype = {
  constructor: EnterNode5,
  appendChild: function(child) {
    return this._parent.insertBefore(child, this._next);
  },
  insertBefore: function(child, next) {
...
function bindIndex5(parent, group2, enter, update, exit, data) {
  var i = 0, node, groupLength = group2.length, dataLength = data.length;
  for (; i < dataLength; ++i) {
    if (node = group2[i]) {
      node.__data__ = data[i];
      ...
      enter[i] = new EnterNode5(parent, data[i]);
    }
  }
  for (; i < groupLength; ++i) {
    if (node = group2[i]) {
...
function bindKey5(parent, group2, enter, update, exit, data, key) {
  var i, node, nodeByKeyValue = /* @__PURE__ */ new Map(), groupLength = group2.length, dataLength = data.length, keyValues = new Array(groupLength), keyValue;
  for (i = 0; i < groupLength; ++i) {
    if (node = group2[i]) {
      keyValues[i] = keyValue = key.call(node, node.__data__, i, group2) + "";
...
function datum5(node) {
  return node.__data__;
}
function data_default6(value, key) {
  if (!arguments.length) return Array.from(this, datum5);
  var bind = key ? bindKey5 : bindIndex5, parents = this._parents, groups2 = this._groups;
  if (typeof value !== "function") value = constant_default14(value);
  for (var m3 = groups2.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group2 = groups2[j], groupLength = group2.length, data = arraylike5(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group2, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1) i1 = i0 + 1;
  ...
  update = new Selection6(update, parents);
  update._enter = enter;
  update._exit = exit;
  return update;
}
function arraylike5(data) {
  return typeof data === "object" && "length" in data ? data : Array.from(data);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/exit.js
function exit_default5() {
  return new Selection6(this._exit || this._groups.map(sparse_default5), this._parents);
}
...
function sort_default6(compare) {
  ...
  return new Selection6(sortgroups, this._parents).order();
}
...
function attrConstant6(name, value) {
  return function() {
    this.setAttribute(name, value);
  };
}
function attrConstantNS6(fullname, value) {
  return function() {
    this.setAttributeNS(fullname.space, fullname.local, value);
  };
}
function attrFunction6(name, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) this.removeAttribute(name);
    else this.setAttribute(name, v2);
...
function attrFunctionNS6(fullname, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) this.removeAttributeNS(fullname.space, fullname.local);
    else this.setAttributeNS(fullname.space, fullname.local, v2);
...
function attr_default6(name, value) {
  ...
  return this.each((value == null ? fullname.local ? attrRemoveNS6 : attrRemove6 : typeof value === "function" ? fullname.local ? attrFunctionNS6 : attrFunction6 : fullname.local ? attrConstantNS6 : attrConstant6)(fullname, value));
}

// node_modules/d3-zoom/node_modules/d3-selection/src/window.js
function window_default5(node) {
  return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}
...
function styleConstant6(name, value, priority) {
  return function() {
    this.style.setProperty(name, value, priority);
  };
}
function styleFunction6(name, value, priority) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) this.style.removeProperty(name);
    else this.style.setProperty(name, v2, priority);
...
function style_default6(name, value, priority) {
  return arguments.length > 1 ? this.each((value == null ? styleRemove6 : typeof value === "function" ? styleFunction6 : styleConstant6)(name, value, priority == null ? "" : priority)) : styleValue5(this.node(), name);
}
function styleValue5(node, name) {
  return node.style.getPropertyValue(name) || window_default5(node).getComputedStyle(node, null).getPropertyValue(name);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/property.js
function propertyRemove5(name) {
  return function() {
    delete this[name];
  };
}
function propertyConstant5(name, value) {
  return function() {
    this[name] = value;
  };
}
function propertyFunction5(name, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (v2 == null) delete this[name];
    else this[name] = v2;
...
function property_default5(name, value) {
  return arguments.length > 1 ? this.each((value == null ? propertyRemove5 : typeof value === "function" ? propertyFunction5 : propertyConstant5)(name, value)) : this.node()[name];
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/classed.js
function classArray5(string) {
  return string.trim().split(/^|\s+/);
}
function classList5(node) {
  return node.classList || new ClassList5(node);
}
function ClassList5(node) {
  this._node = node;
  this._names = classArray5(node.getAttribute("class") || "");
}
ClassList5.prototype = {
  add: function(name) {
    var i = this._names.indexOf(name);
    if (i < 0) {
      this._names.push(name);
...
function classedAdd5(node, names) {
  var list = classList5(node), i = -1, n = names.length;
  while (++i < n) list.add(names[i]);
}
function classedRemove5(node, names) {
  var list = classList5(node), i = -1, n = names.length;
  while (++i < n) list.remove(names[i]);
}
function classedTrue5(names) {
  return function() {
    classedAdd5(this, names);
  };
}
function classedFalse5(names) {
  return function() {
    classedRemove5(this, names);
  };
}
function classedFunction5(names, value) {
  return function() {
    (value.apply(this, arguments) ? classedAdd5 : classedRemove5)(this, names);
  };
}
function classed_default5(name, value) {
  var names = classArray5(name + "");
  if (arguments.length < 2) {
    var list = classList5(this.node()), i = -1, n = names.length;
    while (++i < n) if (!list.contains(names[i])) return false;
    return true;
  }
  return this.each((typeof value === "function" ? classedFunction5 : value ? classedTrue5 : classedFalse5)(names, value));
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/text.js
function textRemove5() {
  this.textContent = "";
}
...
function text_default7(value) {
  return arguments.length ? this.each(value == null ? textRemove5 : (typeof value === "function" ? textFunction6 : textConstant6)(value)) : this.node().textContent;
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/html.js
function htmlRemove5() {
  this.innerHTML = "";
}
function htmlConstant5(value) {
  return function() {
    this.innerHTML = value;
  };
}
function htmlFunction5(value) {
  return function() {
    var v2 = value.apply(this, arguments);
    this.innerHTML = v2 == null ? "" : v2;
  };
}
function html_default5(value) {
  return arguments.length ? this.each(value == null ? htmlRemove5 : (typeof value === "function" ? htmlFunction5 : htmlConstant5)(value)) : this.node().innerHTML;
}
...
function raise_default5() {
  return this.each(raise5);
}
...
function lower_default5() {
  return this.each(lower5);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/append.js
function append_default5(name) {
  var create2 = typeof name === "function" ? name : creator_default5(name);
  return this.select(function() {
    return this.appendChild(create2.apply(this, arguments));
  });
}
...
function constantNull5() {
  return null;
}
function insert_default5(name, before) {
  var create2 = typeof name === "function" ? name : creator_default5(name), select = before == null ? constantNull5 : typeof before === "function" ? before : selector_default5(before);
  return this.select(function() {
    return this.insertBefore(create2.apply(this, arguments), select.apply(this, arguments) || null);
  });
}
...
function selection_cloneShallow5() {
  var clone = this.cloneNode(false), parent = this.parentNode;
  return parent ? parent.insertBefore(clone, this.nextSibling) : clone;
}
function selection_cloneDeep5() {
  var clone = this.cloneNode(true), parent = this.parentNode;
  return parent ? parent.insertBefore(clone, this.nextSibling) : clone;
}
function clone_default5(deep) {
  return this.select(deep ? selection_cloneDeep5 : selection_cloneShallow5);
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/datum.js
function datum_default5(value) {
  return arguments.length ? this.property("__data__", value) : this.node().__data__;
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/on.js
function contextListener5(listener) {
  return function(event) {
    listener.call(this, event, this.__data__);
  };
}
...
function onAdd5(typename, value, options) {
  return function() {
    var on = this.__on, o, listener = contextListener5(value);
    if (on) for (var j = 0, m3 = on.length; j < m3; ++j) {
      if ((o = on[j]).type === typename.type && o.name === typename.name) {
        this.removeEventListener(o.type, o.listener, o.options);
        this.addEventListener(o.type, o.listener = listener, o.options = options);
...
function on_default6(typename, value, options) {
  ...
  on = value ? onAdd5 : onRemove5;
  for (i = 0; i < n; ++i) this.each(on(typenames[i], value, options));
  return this;
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/dispatch.js
function dispatchEvent5(node, type2, params) {
  var window2 = window_default5(node), event = window2.CustomEvent;
  if (typeof event === "function") {
    event = new event(type2, params);
  } else {
    event = window2.document.createEvent("Event");
...
function dispatchConstant5(type2, params) {
  return function() {
    return dispatchEvent5(this, type2, params);
  };
}
function dispatchFunction5(type2, params) {
  return function() {
    return dispatchEvent5(this, type2, params.apply(this, arguments));
  };
}
function dispatch_default6(type2, params) {
  return this.each((typeof params === "function" ? dispatchFunction5 : dispatchConstant5)(type2, params));
}

// node_modules/d3-zoom/node_modules/d3-selection/src/selection/iterator.js
function* iterator_default6() {
  for (var groups2 = this._groups, j = 0, m3 = groups2.length; j < m3; ++j) {
    for (var group2 = groups2[j], i = 0, n = group2.length, node; i < n; ++i) {
      if (node = group2[i]) yield node;
    }
...
var root6 = [null];
function Selection6(groups2, parents) {
  this._groups = groups2;
  this._parents = parents;
}
function selection5() {
  return new Selection6([[document.documentElement]], root6);
}
function selection_selection5() {
  return this;
}
Selection6.prototype = selection5.prototype = {
  constructor: Selection6,
  select: select_default10,
  selectAll: selectAll_default10,
  selectChild: selectChild_default5,
  selectChildren: selectChildren_default5,
  filter: filter_default6,
  data: data_default6,
  enter: enter_default5,
  exit: exit_default5,
  join: join_default5,
  merge: merge_default6,
  selection: selection_selection5,
  order: order_default5,
  sort: sort_default6,
  call: call_default5,
  nodes: nodes_default5,
  node: node_default5,
  size: size_default6,
  empty: empty_default5,
  each: each_default6,
  attr: attr_default6,
  style: style_default6,
  property: property_default5,
  classed: classed_default5,
  text: text_default7,
  html: html_default5,
  raise: raise_default5,
  lower: lower_default5,
  append: append_default5,
  insert: insert_default5,
  remove: remove_default7,
  clone: clone_default5,
  datum: datum_default5,
  on: on_default6,
  dispatch: dispatch_default6,
  [Symbol.iterator]: iterator_default6
};

// node_modules/d3-zoom/node_modules/d3-selection/src/select.js
function select_default11(selector) {
  return typeof selector === "string" ? new Selection6([[document.querySelector(selector)]], [document.documentElement]) : new Selection6([[selector]], root6);
}
...
Local5.prototype = local6.prototype = {
  constructor: Local5,
  get: function(node) {
    var id2 = this._;
    while (!(id2 in node)) if (!(node = node.parentNode)) return;
...
function sourceEvent_default5(event) {
  let sourceEvent;
  while (sourceEvent = event.sourceEvent) event = sourceEvent;
  return event;
}
...
function pointer_default5(event, node) {
  event = sourceEvent_default5(event);
  if (node === void 0) node = event.currentTarget;
  if (node) {
    var svg2 = node.ownerSVGElement || node;
    if (svg2.createSVGPoint) {
...
function zoom_default2() {
  var filter7 = defaultFilter3, extent2 = defaultExtent2, constrain = defaultConstrain, wheelDelta = defaultWheelDelta, touchable = defaultTouchable3, scaleExtent = [0, Infinity], translateExtent = [[-Infinity, -Infinity], [Infinity, Infinity]], duration = 250, interpolate = zoom_default, listeners = dispatch_default("start", "zoom", "end"), touchstarting, touchfirst, touchending, touchDelay = 500, wheelDelay = 150, clickDistance2 = 0, tapDistance = 10;
  function zoom(selection6) {
    selection6.property("__zoom", defaultTransform).on("wheel.zoom", wheeled, { passive: false }).on("mousedown.zoom", mousedowned).on("dblclick.zoom", dblclicked).filter(touchable).on("touchstart.zoom", touchstarted).on("touchmove.zoom", touchmoved).on("touchend.zoom touchcancel.zoom", touchended).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  zoom.transform = function(collection, transform2, point6, event) {
    var selection6 = collection.selection ? collection.selection() : collection;
    selection6.property("__zoom", defaultTransform);
    if (collection !== selection6) {
      schedule(collection, transform2, point6, event);
    } else {
      selection6.interrupt().each(function() {
        gesture(this, arguments).event(event).start().zoom(null, typeof transform2 === "function" ? transform2.apply(this, arguments) : transform2).end();
      });
    }
  };
  zoom.scaleBy = function(selection6, k2, p, event) {
    zoom.scaleTo(selection6, function() {
      var k0 = this.__zoom.k, k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return k0 * k1;
    }, p, event);
  };
  zoom.scaleTo = function(selection6, k2, p, event) {
    zoom.transform(selection6, function() {
  ...
  zoom.translateBy = function(selection6, x4, y4, event) {
    zoom.transform(selection6, function() {
  ...
  zoom.translateTo = function(selection6, x4, y4, p, event) {
    zoom.transform(selection6, function() {
  ...
  Gesture.prototype = {
    ...
    emit: function(type2) {
      var d = select_default11(this.that).datum();
      listeners.call(
        type2,
        this.that,
        new ZoomEvent(type2, {
  ...
  function wheeled(event, ...args) {
    if (!filter7.apply(this, arguments)) return;
    var g = gesture(this, args).event(event), t = this.__zoom, k2 = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t.k * Math.pow(2, wheelDelta.apply(this, arguments)))), p = pointer_default5(event);
    if (g.wheel) {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v2 = select_default11(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default5(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default(event.view);
    ...
    function mousemoved(event2) {
      ...
      g.event(event2).zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = pointer_default5(event2, currentTarget), g.mouse[1]), g.extent, translateExtent));
    }
  ...
  function dblclicked(event, ...args) {
    if (!filter7.apply(this, arguments)) return;
    var t03 = this.__zoom, p02 = pointer_default5(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t03.invert(p02), k1 = t03.k * (event.shiftKey ? 0.5 : 2), t13 = constrain(translate(scale2(t03, k1), p02, p1), extent2.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0) select_default11(this).transition().duration(duration).call(schedule, t13, p02, event);
    else select_default11(this).call(zoom.transform, t13, p02, event);
  }
  function touchstarted(event, ...args) {
    ...
    nopropagation3(event);
    for (i = 0; i < n; ++i) {
      t = touches[i], p = pointer_default5(t, this);
