...
// node_modules/wave-roll/dist/WebGPURenderer-CKUAjSgR.js
var y = m.for2d();
var O = class {
  start(e, t, r) {
...
var I = class {
  ...
  _createBindGroup(e, t, r) {
    ...
    const u = o.shader.getProgramData(t).bindGroups[r], c2 = s.createBindGroup({
      layout: u,
      entries: n
    });
    return this._hash[e._key] = c2, c2;
  }
  destroy() {
...
var W = class {
  ...
  createGPUBuffer(e) {
    ...
    return e._updateID = 0, e.data && (Jh(e.data.buffer, t.getMappedRange()), t.unmap()), this._gpuBuffers[e.uid] = t, t;
  }
  onBufferChange(e) {
...
var U = class {
  ...
  async _createDeviceAndAdaptor(e) {
    const t = await Ce.get().getNavigator().gpu.requestAdapter({
...
var N = class {
  ...
  draw(e) {
    const { geometry: t, shader: r, state: s, topology: i, size: n, start: o, instanceCount: u, skipSync: c2 } = e;
    this.setPipelineFromGeometryProgramAndState(t, r.gpuProgram, s, i), this.setGeometry(t, r.gpuProgram), this._setShaderBindGroups(r, c2), t.indexBuffer ? this.renderPassEncoder.drawIndexed(
...
var Y = class {
  constructor(e) {
    ...
    const t = 256 / b;
    for (let r = 0; r < t; r++) {
      let s = fe.UNIFORM | fe.COPY_DST;
      r === 0 && (s |= fe.COPY_SRC), this._buffers.push(new jn({
  ...
  _getBufferResource(e) {
    if (!this._bufferResources[e]) {
      ...
      this._bufferResources[e] = new Ft({
        buffer: t,
        offset: (e / 2 | 0) * 256,
        size: b
      });
...
var $ = class {
  ...
  contextChange(e) {
    this._gpu = e, this.setStencilMode(_0.DISABLED), this._updatePipeHash();
  }
  ...
  setStencilMode(e) {
    this._stencilMode !== e && (this._stencilMode = e, this._stencilState = x[e], this._updatePipeHash());
  }
  setPipeline(e, t, r, s) {
  ...
  getPipeline(e, t, r, s) {
    e._layoutKey || (It(e, t.attributeData), this._generateBufferKey(e)), s || (s = e.topology);
    const i = Ee(
      e._layoutKey,
      t._layoutKey,
      r.data,
  ...
  _createPipeline(e, t, r, s) {
    ...
    o[0].writeMask = this._stencilMode === _0.RENDERING_MASK_ADD ? 0 : this._colorMask;
    const u = this._renderer.shader.getProgramData(t).pipeline, c2 = {
    ...
    return this._depthStencilAttachment && (c2.depthStencil = {
      ...this._stencilState,
      format: "depth24plus-stencil8",
      depthWriteEnabled: r.depthTest,
      depthCompare: r.depthTest ? "less" : "always"
    }), i.createRenderPipeline(c2);
  }
  _getModule(e) {
  ...
  _generateBufferKey(e) {
    ...
    const i = t.join("|");
    return e._layoutKey = Nl(i, "geometry"), e._layoutKey;
  }
  _generateAttributeLocationsKey(e) {
    ...
    const i = t.join("|");
    return e._attributeLocationsKey = Nl(i, "programAttributes"), e._attributeLocationsKey;
  }
  /**
  ...
  getBufferNamesToBind(e, t) {
    ...
    for (let o = 0; o < s.length; o++) {
      const c2 = Object.values(s[o].attributes)[0].shaderLocation;
      for (const l in n)
        if (n[l].location === c2) {
          i[o] = l;
          break;
  ...
  _createVertexBufferLayouts(e, t) {
    ...
    return e.buffers.forEach((i) => {
      ...
      for (const u in t.attributeData) {
        const c2 = e.attributes[u];
        (c2.divisor ?? 1) !== 1 && $t(`Attribute ${u} has an invalid divisor value of '${c2.divisor}'. WebGPU only supports a divisor value of 1`), c2.buffer === i && (n.arrayStride = c2.stride, n.stepMode = c2.instance ? "instance" : "vertex", o.push({
...
var ke = class {
  ...
  getDescriptor(e, t, r) {
    ...
    if ((e.stencil || e.depth) && !e.depthStencilTexture && (e.ensureDepthStencilTexture(), e.depthStencilTexture.source.sampleCount = i.msaa ? 4 : 1), e.depthStencilTexture) {
      const c2 = t & Hf.STENCIL ? "clear" : "load", l = t & Hf.DEPTH ? "clear" : "load";
      o = {
  ...
  clear(e, t = true, r, s) {
    ...
    if (n.commandEncoder === null) {
      const c2 = o.createCommandEncoder(), l = this.getDescriptor(e, t, r), h = c2.beginRenderPass(l);
  ...
  resizeGpuRenderTarget(e) {
    ...
    t.width = e.width, t.height = e.height, t.msaa && e.colorTextures.forEach((r, s) => {
      var _a;
      (_a = t.msaaTextures[s]) == null ? void 0 : _a.resize(
        r.source.width,
        r.source.height,
...
var J = class {
  constructor() {
    this.defaultState = new m(), this.defaultState.blend = true;
  }
  contextChange(e) {
    this.gpu = e;
  }
    ...
    return [
      {
        format: "bgra8unorm",
        writeMask: 0,
        blend: g2[e.blendMode] || g2.normal
      }
    ];
  }
  destroy() {
...
var He = { blockBytes: 4, blockWidth: 1, blockHeight: 1 };
var ze = {
  type: "compressed",
  upload(a, e, t) {
...
var ee = {
  ...
  upload(a, e, t) {
    ...
    if (globalThis.HTMLImageElement && r instanceof HTMLImageElement) {
      const o = Ce.get().createCanvas(r.width, r.height);
      o.getContext("2d").drawImage(r, 0, 0, r.width, r.height), a.resource = o, $t("ImageSource: Image element passed, converting to canvas and replacing resource.");
    }
  ...
  generateMipmap(e) {
    ...
    for (let u = 0; u < s; ++u) {
      ...
      for (let h = 1; h < e.mipLevelCount; ++h) {
        ...
        d.setPipeline(t), d.setBindGroup(0, _), d.draw(3, 1, 0, 0), d.end(), c2 = f;
      }
    }
    if (!i) {
      const u = {
      ...
      for (let c2 = 1; c2 < e.mipLevelCount; ++c2)
...
var te = class {
  ...
  _createTextureBindGroup(e) {
    const t = e.source;
    return this._bindGroupHash[e.uid] = new to({
      0: t,
      1: t.style,
      2: new qf({
  ...
  generateCanvas(e) {
    ...
    return i.configure({
      ...
      format: Ce.get().getNavigator().gpu.getPreferredCanvasFormat(),
  ...
  getPixels(e) {
    const t = this.generateCanvas(e), r = Su.getOptimalCanvasAndContext(t.width, t.height), s = r.context;
    s.drawImage(t, 0, 0);
    const { width: i, height: n } = t, o = s.getImageData(0, 0, i, n), u = new Uint8ClampedArray(o.data.buffer);
    return Su.returnCanvasAndContext(r), { pixels: u, width: i, height: n };
  }
  destroy() {
    var _a;
...
var re = class {
  ...
  execute(e, t) {
    const r = t.context, s = r.customShader || this.shader, i = e.renderer, n = i.graphicsContext, {
      batcher: o,
      instructions: u
    } = n.getContextRenderData(r), c2 = i.encoder;
    c2.setGeometry(o.geometry, s.gpuProgram);
    const l = i.globalUniforms.bindGroup;
    c2.setBindGroup(0, l, s.gpuProgram);
    const h = i.renderPipes.uniformBatch.getUniformBindGroup(s.resources.localUniforms, true);
    c2.setBindGroup(2, h, s.gpuProgram);
    const f = u.instructions;
    let d = null;
    for (let _ = 0; _ < u.instructionSize; _++) {
      const m2 = f[_];
      if (m2.topology !== d && (d = m2.topology, c2.setPipelineFromGeometryProgramAndState(
        o.geometry,
        s.gpuProgram,
        e.state,
        m2.topology
      )), s.groups[1] = m2.bindGroup, !m2.gpuBindGroup) {
        const P = m2.textures;
        m2.bindGroup = m0(
          P.textures,
          P.count,
          this._maxTextures
        ), m2.gpuBindGroup = i.bindGroup.getBindGroup(
          m2.bindGroup,
          s.gpuProgram,
          1
        );
      }
      c2.setBindGroup(1, m2.bindGroup, s.gpuProgram), c2.renderPassEncoder.drawIndexed(m2.size, 1, m2.start);
    }
  }
  destroy() {
...
var se = class {
  init() {
    ...
    this._shader = new Vl({
      gpuProgram: e,
      resources: {
        uTexture: nt.EMPTY._source,
        uSampler: nt.EMPTY._source.style,
        textureUniforms: {
...
var ne = [];
var oe = [];
Be.handleByNamedList(ht.WebGPUSystem, ie);
Be.handleByNamedList(ht.WebGPUPipes, ne);
Be.handleByNamedList(ht.WebGPUPipesAdaptor, oe);
Be.add(...Ie, ...We, ...Ve);
var qe = class extends Yf {
  constructor() {
    const e = {
      name: "webgpu",
      type: tl.WEBGPU,
...
//# sourceMappingURL=WebGPURenderer-CKUAjSgR-6HZCHKJJ.js.map
