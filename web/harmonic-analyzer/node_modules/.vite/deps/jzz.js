  ...
  "node_modules/jzz/javascript/JZZ.js"(exports, module) {
    (function(global2, factory) {
      if (typeof exports === "object" && typeof module !== "undefined") {
        ...
        if (!global2) global2 = window;
        if (global2.JZZ && global2.JZZ.MIDI) return;
        global2.JZZ = factory();
      }
    })(exports, function() {
      ...
      function _push(arr, obj) {
        for (var i2 = 0; i2 < arr.length; i2++) if (arr[i2] === obj) return;
        arr.push(obj);
      }
      function _pop(arr, obj) {
        for (var i2 = 0; i2 < arr.length; i2++) if (arr[i2] === obj) {
          arr.splice(i2, 1);
          return;
        }
      }
      ...
      _J.prototype = new _R();
      function _for(x, f) {
        for (var k2 in x) if (x.hasOwnProperty(k2)) f.call(this, k2);
      }
      function _clone(obj, key, val) {
        if (typeof key == "undefined") return _clone(obj, [], []);
        if (obj instanceof Object) {
          for (var i2 = 0; i2 < key.length; i2++) if (key[i2] === obj) return val[i2];
          var ret;
      ...
      function _filterList(q, arr) {
        ...
        for (i2 = 0; i2 < q.length; i2++) {
          if (typeof q[i2] == "undefined") a = after;
          else if (q[i2] instanceof RegExp) for (n2 = 0; n2 < etc.length; n2++) {
            ...
            for (n2 = 0; n2 < etc.length; n2++) if (q[i2] + "" === n2 + "" || q[i2] === etc[n2].name || q[i2] instanceof Object && q[i2].name === etc[n2].name) {
              a.push(etc[n2]);
              etc.splice(n2, 1);
              n2--;
            }
      ...
      function _openMidiOut(port, arg) {
        if (this._bad) port._crash(this._err());
          ...
          for (var i2 = 0; i2 < arr.length; i2++) arr[i2] = pack(arr[i2]);
      ...
      _M.prototype.note = function(c, n2, v, t) {
        ...
        if (typeof this._ch == "undefined" && typeof this._master == "undefined") {
          if (t > 0) this.wait(t).noteOff(c, n2);
        } else {
      ...
      _M.prototype._emit = function(msg) {
        ...
        for (i2 = 0; i2 < this._handles.length; i2++) {
          m2 = _midi(msg);
          this._handles[i2].apply(this, [m2._stamp(this)]);
        }
        for (i2 = 0; i2 < this._outs.length; i2++) {
          m2 = _midi(msg);
          if (!m2._stamped(this._outs[i2])) this._outs[i2].send(m2._stamp(this));
        }
      };
      function _emit(msg) {
        this._emit(msg);
      ...
      _M.prototype.mpe = function(m2, n2) {
        if (m2 == this._master && n2 == this._band || typeof m2 == "undefined" && typeof this._master == "undefined") return this._thenable();
        if (typeof m2 != "undefined") MPE.validate(m2, n2);
        if (!n2) return this.ch(m2);
        var img = this._image();
        img._ch = void 0;
        img._master = m2;
        img._band = n2;
      ...
      function _changed(x0, y0, x1, y1) {
        ...
        for (i2 = 0; i2 < x0.length; i2++) if (x0[i2].name != x1[i2].name) return true;
        for (i2 = 0; i2 < y0.length; i2++) if (y0[i2].name != y1[i2].name) return true;
        return false;
      }
      function _diff(x0, y0, x1, y1) {
        ...
        var i2;
        var h = {};
        for (i2 = 0; i2 < x0.length; i2++) h[x0[i2].name] = true;
        for (i2 = 0; i2 < x1.length; i2++) if (!h[x1[i2].name]) ax.push(x1[i2]);
        h = {};
        for (i2 = 0; i2 < x1.length; i2++) h[x1[i2].name] = true;
        for (i2 = 0; i2 < x0.length; i2++) if (!h[x0[i2].name]) rx.push(x0[i2]);
        h = {};
        for (i2 = 0; i2 < y0.length; i2++) h[y0[i2].name] = true;
        for (i2 = 0; i2 < y1.length; i2++) if (!h[y1[i2].name]) ay.push(y1[i2]);
        h = {};
        for (i2 = 0; i2 < y1.length; i2++) h[y1[i2].name] = true;
        for (i2 = 0; i2 < y0.length; i2++) if (!h[y0[i2].name]) ry.push(y0[i2]);
      ...
      function _filterEngines(opt) {
        ...
        for (var i2 = 0; i2 < arr.length; i2++) {
          if (arr[i2] == "webmidi") {
            ...
            ret.push(_tryNODE);
            ret.push(_zeroBreak);
          } else if (arr[i2] == "extension") ret.push(_tryCRX);
          else if (arr[i2] == "plugin") ret.push(_tryJazzPlugin);
        }
        ret.push(_initNONE);
        return ret;
      }
      ...
      function _initEngineJP() {
        ...
        var watcher;
        function _closeAll() {
          for (var i2 = 0; i2 < this.clients.length; i2++) this._close(this.clients[i2]);
        }
        _engine._refresh = function() {
          _engine._outs = [];
          _engine._ins = [];
        ...
        _engine._close = function() {
          for (var i2 = 0; i2 < _engine._inArr.length; i2++) if (_engine._inArr[i2].open) _engine._inArr[i2].plugin.MidiInClose();
          _engine._unwatch();
        };
      ...
      function _initCRX(msg, ver) {
        ...
        document.addEventListener("jazz-midi-msg", function(evt) {
          ...
          for (i2 = 0; i2 < v.length; i2++) {
            ...
            if (a[0] === "refresh") {
              if (a[1].ins) {
                for (j2 = 0; j2 < a[1].ins.length; j2++) a[1].ins[j2].type = _engine._type;
                _engine._ins = a[1].ins;
              }
              if (a[1].outs) {
                for (j2 = 0; j2 < a[1].outs.length; j2++) a[1].outs[j2].type = _engine._type;
                _engine._outs = a[1].outs;
              }
              _postRefresh();
              for (j2 = 0; j2 < _engine.refreshClients.length; j2++) _engine.refreshClients[j2]._resume();
              _engine.refreshClients = [];
            } else if (a[0] === "version") {
              ...
              if (impl) {
                if (a[2] == impl.name) {
                  impl.open = true;
                  if (impl.clients) for (j2 = 0; j2 < impl.clients.length; j2++) impl.clients[j2]._resume();
                } else if (impl.clients) for (j2 = 0; j2 < impl.clients.length; j2++) impl.clients[j2]._crash();
              }
            } else if (a[0] === "openin") {
      ...
      function Widget(arg) {
        var self = new _M();
        if (arg instanceof Object) _for(arg, function(k2) {
          self[k2] = arg[k2];
        });
        self._resume();
        return self;
      ...
      SMPTE.prototype.read = function(m2) {
        if (!(m2 instanceof MIDI)) m2 = MIDI.apply(null, arguments);
      ...
      function _mtc(t) {
        if (!t.backwards && t.quarter >= 4) t.decrFrame();
      ...
      function _hrtype(t) {
        if (t.type == 25) return t.hour | 32;
        if (t.type == 29.97) return t.hour | 64;
        if (t.type == 30) return t.hour | 96;
        return t.hour;
      }
      function _dec(x) {
        return x < 10 ? "0" + x : x;
      ...
      function _smptetxt(x) {
        var arr = [];
        for (var i2 = 0; i2 < x.length; i2++) arr[i2] = _dec(i2 ? x[i2] : x[i2] & 31);
        return arr.join(":");
      }
      ...
      function MIDI(arg) {
        ...
        for (i2 = 0; i2 < arr.length; i2++) {
          n = arr[i2];
          if (i2 == 1) {
            if (self[0] >= 128 && self[0] <= 175) n = MIDI.noteValue(n);
            if (self[0] >= 192 && self[0] <= 207) n = MIDI.programValue(n);
          }
          if (n != parseInt(n) || n < 0 || n > 255) _throw(arr[i2]);
          self.push(n);
        }
        return self;
      }
      ...
      MIDI.octaveValue = function(x) {
        ...
        if (typeof n2 == "undefined") n2 = _noteNum[x.toString().toLowerCase() + "1"];
        return typeof n2 == "undefined" ? void 0 : n2 % 12;
      };
      MIDI.freq = function(n2, a) {
        if (typeof a == "undefined") a = 440;
        _float(a);
      ...
      MIDI.to21b = function(x) {
        if (typeof x == "undefined") return 2097151;
        _float(x);
        if (x <= 0) return 0;
      ...
      MIDI.to32b = function(x) {
        _float(x);
        return x <= 0 ? 0 : x >= 1 ? 4294967295 : Math.floor(x * 4294967296);
      };
      function _MIDI() {
      }
      ...
      function _7b(n2, m2) {
        if (n2 != parseInt(n2) || n2 < 0 || n2 > 127) _throw(typeof m2 == "undefined" ? n2 : m2);
        return parseInt(n2);
      }
      function _8b(n2) {
      ...
      function _8bs(s) {
        s = "" + s;
        for (var i2 = 0; i2 < s.length; i2++) if (s.charCodeAt(i2) > 255) _throw(s[i2]);
        return s;
      }
      function _to777(n2) {
      ...
      function _ntu(x) {
        ...
        _for(x, function(k3) {
          m2 = _21b(x[k3]);
          k3 = _7bn(k3);
          if (k3 in vvv) throw RangeError("Duplicate MIDI value: " + k3);
          kkk.push(k3);
          vvv[k3] = m2;
        });
        kkk.sort();
        var out = [kkk.length];
        for (k2 = 0; k2 < kkk.length; k2++) out = out.concat([kkk[k2]], _to777(vvv[kkk[k2]]));
        return out;
      }
      function _f2ntu(x) {
        var out = {};
      ...
      function _12x7(a) {
        ...
        for (var i2 = 0; i2 < 12; i2++) out.push(_7b(a[i2]));
        return out;
      }
      function _12x14(a) {
        var out = [];
      ...
      function _splitMasterTuning(a, b, c, d) {
        ...
        if (a != parseInt(a) || a < 0 || a > 65535) _bad(a);
        a = parseInt(a);
        return [a >> 12 & 15, a >> 8 & 15, a >> 4 & 15, a & 15];
      }
      function _gsxg16b(x) {
        _float(x);
        x = Math.round(x * 65536 + 16384);
      ...
      var _helperSX = {
        ...
        sxMasterVolumeF: function(x) {
          return _helperSX.sxMasterVolume.call(this, MIDI.to14b(_01(x)));
        },
        ...
        sxMasterFineTuningF: function(x) {
          return _helperSX.sxMasterFineTuning.call(this, MIDI.to14b(_01((x % 1 + 1) / 2, x)));
        },
        sxMasterCoarseTuning: function(n2) {
          return [240, 127, this._sxid, 4, 4, 0, _7b(n2), 247];
        },
        sxMasterCoarseTuningF: function(x) {
          return _helperSX.sxMasterCoarseTuning.call(this, 64 + (x - x % 1));
        },
        ...
        sxNoteTuningF: function(a, b, c, d) {
          return b == parseInt(b) ? _helperSX.sxNoteTuning.call(this, a, b, _f2ntu(c), d) : _helperSX.sxNoteTuning.call(this, a, _f2ntu(b));
        },
        sxNoteTuningHZ: function(a, b, c, d) {
          return b == parseInt(b) ? _helperSX.sxNoteTuning.call(this, a, b, _hz2ntu(c), d) : _helperSX.sxNoteTuning.call(this, a, _hz2ntu(b));
        },
        sxScaleTuning1: function(a, b, c) {
          return a == parseInt(a) ? [240, _rt(c), this._sxid, 8, 8].concat(_to777(_16b(a)), _12x7(b), [247]) : _helperSX.sxScaleTuning1.call(this, 65535, a, b);
        },
        sxScaleTuning1F: function(a, b, c) {
          if (a != parseInt(a)) return _helperSX.sxScaleTuning1F.call(this, 65535, a, b);
          var v = [];
          for (var i2 = 0; i2 < b.length; i2++) {
            if (b[i2] < -0.64 || b[i2] > 0.63) throw RangeError("Out of range: " + b[i2]);
            v.push(Math.floor(b[i2] * 100 + 64));
          }
          return _helperSX.sxScaleTuning1.call(this, a, v, c);
        },
        sxScaleTuning2: function(a, b, c) {
          return a == parseInt(a) ? [240, _rt(c), this._sxid, 8, 9].concat(_to777(_16b(a)), _12x14(b), [247]) : _helperSX.sxScaleTuning2.call(this, 65535, a, b);
        },
        sxScaleTuning2F: function(a, b, c) {
          if (a != parseInt(a)) return _helperSX.sxScaleTuning2F.call(this, 65535, a, b);
          var v = [];
          for (var i2 = 0; i2 < b.length; i2++) {
            var x = (b[i2] + 1) / 2;
            if (x < -1 || x > 1) throw RangeError("Out of range: " + b[i2]);
        ...
        sxXG: function(arg) {
          ...
          for (var i2 = 0; i2 < arr.length; i2++) a.push(_7b(arr[i2]));
          a.push(247);
          return a;
        },
        sxMidiSoft: function(n2, s) {
          ...
          for (var i2 = 0; i2 < s.length; i2++) a.push(_7b(s.charCodeAt(i2)));
          a.push(247);
          return a;
        },
        ...
        gsMasterVolumeF: function(x) {
          return _helperSX.gsMasterVolume.call(this, MIDI.to7b(_01(x)));
        },
        gsMasterFineTuning: function(a, b, c, d) {
          a = _splitMasterTuning(a, b, c, d);
          return _helperSX.sxGS.call(this, [64, 0, 0, a[0], a[1], a[2], a[3]]);
        },
        gsMasterFineTuningF: function(x) {
          return _helperSX.gsMasterFineTuning.call(this, _gsxg16b(x % 1));
        },
        gsMasterCoarseTuning: function(n2) {
          return _helperSX.sxGS.call(this, [64, 0, 5, _7b(n2)]);
        },
        gsMasterCoarseTuningF: function(x) {
          return _helperSX.gsMasterCoarseTuning.call(this, 64 + (x - x % 1));
        },
        gsOctaveTuning: function(c, n2, x) {
          return _helperSX.sxGS.call(this, [64, 16 + [1, 2, 3, 4, 5, 6, 7, 8, 9, 0, 11, 12, 13, 14, 15][_ch(c)], 64 + MIDI.octaveValue(n2), _7b(x)]);
        },
        gsOctaveTuningF: function(c, n2, x) {
          if (x < -0.64 || x > 0.63) throw RangeError("Out of range: " + x);
          return _helperSX.gsOctaveTuning.call(this, c, n2, Math.floor(x * 100 + 64));
        },
        xgMasterVolume: function(n2) {
          return _helperSX.sxXG.call(this, [0, 0, 4, _7b(n2)]);
        },
        xgMasterVolumeF: function(x) {
          return _helperSX.xgMasterVolume.call(this, MIDI.to7b(_01(x)));
        },
        xgMasterFineTuning: function(a, b, c, d) {
          a = _splitMasterTuning(a, b, c, d);
          return _helperSX.sxXG.call(this, [0, 0, 0, a[0], a[1], a[2], a[3]]);
        },
        xgMasterFineTuningF: function(x) {
          return _helperSX.xgMasterFineTuning.call(this, _gsxg16b(x % 1));
        },
        xgMasterCoarseTuning: function(n2) {
          return _helperSX.sxXG.call(this, [0, 0, 6, _7b(n2)]);
        },
        xgMasterCoarseTuningF: function(x) {
          return _helperSX.xgMasterCoarseTuning.call(this, 64 + (x - x % 1));
        },
        xgOctaveTuning: function(c, n2, x) {
          return _helperSX.sxXG.call(this, [8, _ch(c), 65 + MIDI.octaveValue(n2), _7b(x)]);
        },
        xgOctaveTuningF: function(c, n2, x) {
          if (x < -0.64 || x > 0.63) throw RangeError("Out of range: " + x);
          return _helperSX.xgOctaveTuning.call(this, c, n2, Math.floor(x * 100 + 64));
        }
      };
      ...
      var _helperSXX = {
        ...
        sxMasterTuning: function(n2, m2, l) {
          return [_helperSX.sxMasterCoarseTuning.call(this, n2), _helperSX.sxMasterFineTuning.call(this, m2, l)];
        },
        sxMasterTuningF: function(x) {
          return [_helperSX.sxMasterCoarseTuningF.call(this, x), _helperSX.sxMasterFineTuningF.call(this, x)];
        },
        gsMasterTuningF: function(x) {
          return [_helperSX.gsMasterCoarseTuningF.call(this, x), _helperSX.gsMasterFineTuningF.call(this, x)];
        },
        xgMasterTuningF: function(x) {
          return [_helperSX.xgMasterCoarseTuningF.call(this, x), _helperSX.xgMasterFineTuningF.call(this, x)];
        },
        sxMasterTuningA: function(a) {
          return _helperSXX.sxMasterTuningF.call(this, MIDI.shift(a));
        },
        gsMasterTuningA: function(a) {
          return _helperSXX.gsMasterTuningF.call(this, MIDI.shift(a));
        },
        xgMasterTuningA: function(a) {
          return _helperSXX.xgMasterTuningF.call(this, MIDI.shift(a));
        },
        gsScaleTuning: function(c, a) {
          var out = [];
          if (a.length != 12) throw RangeError("Wrong input size: " + a.length);
          for (var i2 = 0; i2 < 12; i2++) out.push(_helperSX.gsOctaveTuning.call(this, c, i2, a[i2]));
          return out;
        },
        gsScaleTuningF: function(c, a) {
          var out = [];
          if (a.length != 12) throw RangeError("Wrong input size: " + a.length);
          for (var i2 = 0; i2 < 12; i2++) out.push(_helperSX.gsOctaveTuningF.call(this, c, i2, a[i2]));
          return out;
        },
        xgScaleTuning: function(c, a) {
          var out = [];
          if (a.length != 12) throw RangeError("Wrong input size: " + a.length);
          for (var i2 = 0; i2 < 12; i2++) out.push(_helperSX.xgOctaveTuning.call(this, c, i2, a[i2]));
          return out;
        },
        xgScaleTuningF: function(c, a) {
          var out = [];
          if (a.length != 12) throw RangeError("Wrong input size: " + a.length);
          for (var i2 = 0; i2 < 12; i2++) out.push(_helperSX.xgOctaveTuningF.call(this, c, i2, a[i2]));
          return out;
        }
      };
      function _smf(ff, dd) {
      ...
      function _copyHelperGNC(name, func) {
        MIDI[name] = function() {
          ...
          for (i2 = 0; i2 < a.length; i2++) g.push(new MIDI(a[i2]));
          return g;
        };
        _helpers[name] = function() {
          var a = func.apply(this, arguments);
          var g = this;
          for (var i2 = 0; i2 < a.length; i2++) g = g.send(a[i2]);
          return g;
        };
      }
      ...
      function _copyHelperGCH(name, func) {
        ...
        _helpers[name] = function() {
          ...
          g = this;
          for (i2 = 0; i2 < a.length; i2++) g = g.send(a[i2]);
          return g;
        };
      }
      ...
      MIDI.prototype.getChannel = function() {
        ...
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 239) return;
        return c & 15;
      };
      MIDI.prototype.setChannel = function(x) {
        x = _channelMap[x];
        if (typeof x == "undefined") return this;
        if (this.ff == 32) this.dd = String.fromCharCode(x);
        else {
          var c = this[0];
          if (typeof c != "undefined" && c >= 128 && c <= 239) this[0] = c & 240 | x;
        }
        return this;
      };
      MIDI.prototype.getNote = function() {
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 175) return;
        return this[1];
      };
      MIDI.prototype.setNote = function(x) {
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 175) return this;
        x = MIDI.noteValue(x);
      ...
      MIDI.prototype.getVelocity = function() {
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 159) return;
        return this[2];
      };
      MIDI.prototype.setVelocity = function(x) {
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 159) return this;
        x = parseInt(x);
      ...
      MIDI.prototype.getText = function() {
        ...
        if (this.isMidiSoft()) {
          var s = [];
          for (var i2 = 6; i2 < this.length - 1; i2++) s.push(String.fromCharCode(this[i2]));
          return s.join("");
        }
      };
      ...
      MIDI.prototype.isNoteOn = function() {
        var c = this[0];
        if (typeof c == "undefined" || c < 144 || c > 159) return false;
        return this[2] > 0 ? true : false;
      };
      MIDI.prototype.isNoteOff = function() {
        var c = this[0];
        if (typeof c == "undefined" || c < 128 || c > 159) return false;
        if (c < 144) return true;
        return this[2] == 0 ? true : false;
      };
      ...
      MIDI.prototype.match = function(a) {
        ...
        for (i2 = 0; i2 < a.length; i2++) {
          ...
          if (typeof m2 == "undefined") {
            if (this[i2] != a[i2]) return false;
          } else {
            if ((this[i2] & m2) != (a[i2][0] & m2)) return false;
          }
        }
        return true;
      };
      ...
      function _s2n(x) {
        var n2 = 0;
        for (var i2 = 0; i2 < x.length; i2++) n2 = (n2 << 8) + x.charCodeAt(i2);
        return n2;
      }
      function __hex(x) {
      ...
      function _hex(x) {
        var a = [];
        for (var i2 = 0; i2 < x.length; i2++) a.push(__hex(x[i2]));
        return a.join(" ");
      }
      function _hexx(x) {
        var a = [];
      ...
      function _toLine(s) {
        ...
        for (var i2 = 0; i2 < s.length; i2++) {
          if (s[i2] == "\n") out += "\\n";
          else if (s[i2] == "\r") out += "\\r";
          else if (s[i2] == "	") out += "\\t";
          else if (s.charCodeAt(i2) < 32) out += "\\x" + __hex(s.charCodeAt(i2));
          else out += s[i2];
        }
        return out;
      }
      ...
      MIDI.prototype._unstamp = function(obj) {
        if (typeof obj == "undefined") this._from = [];
          ...
          if (i2 > -1) this._from.splice(i2, 1);
        }
        return this;
      };
      MIDI.prototype._stamped = function(obj) {
        if (obj._orig) obj = obj._orig;
        for (var i2 = 0; i2 < this._from.length; i2++) if (this._from[i2] == obj) return true;
        return false;
      };
      JZZ.MIDI = MIDI;
      ...
      function _m2_str(a) {
        ...
        for (i2 = 0; i2 < a.length; i2++) {
          if (!a[i2]) break;
          s += String.fromCharCode(a[i2]);
        }
        return JZZ.lib.fromUTF8(s);
      }
      function _read_ctxt(msg) {
        var mmm, kk, tt, st, n2, a, s;
        var gr = "x";
        var ch = "x";
        if (msg.isMidi2) {
          tt = msg[0] >> 4;
      ...
      MPE.prototype.setup = function(m2, n2) {
        ...
        var k2;
        var last = m2 + n2;
        if (this[m2].master == m2 && this[m2].band == n2) return;
        if (!n2 && !this[m2].band) return;
        if (this[m2].band) {
          k2 = m2 + this[m2].band;
          if (last < k2) last = k2;
        ...
        for (k2 = m2 + 1; k2 <= m2 + n2; k2++) {
          if (this[k2].band && last < k2 + this[k2].band) last = k2 + this[k2].band;
          this[k2] = { band: 0, master: m2 };
        }
        for (; k2 <= last; k2++) this[k2] = { band: 0, master: k2 };
      };
      ...
      UMP.prototype.dump = function() {
        var i2;
        var s = "";
        for (i2 = 0; i2 < this.length; i2++) s += String.fromCharCode(this[i2]);
        return s;
      };
      function _UMP() {
      }
      ...
      UMP.prototype.getGroup = function() {
        if (!this[0]) return;
        var m2 = this[0] >> 4;
        if (m2 == 1 || m2 == 2 || m2 == 3 || m2 == 4 || m2 == 5 || m2 == 13) return this[0] & 15;
      };
      ...
      function _f_32(x) {
        ...
        return x > 4294967295 ? 4294967295 : x < 0 ? 0 : x;
      }
      var _helperNN = {
        noop: function() {
          return [0, 0, 0, 0];
      ...
      var _helperGN = {
        umpTempo: function(g, n2) {
          return [208 + _4b(g), 16, 0, 0].concat(_32a(n2), [0, 0, 0, 0, 0, 0, 0, 0]);
        },
        umpBPM: function(g, n2) {
          return _helperGN.umpTempo(g, Math.round(6e9 / n2));
        },
        umpTimeSignature: function(g, a, b) {
          ...
          if (nn > 0 && nn < 256 && cc > 0 && !(cc & cc - 1)) {
            ...
            if (cc < 256) return [208 + _4b(g), 16, 0, 1, nn, dd, cc, 0, 0, 0, 0, 0, 0, 0, 0, 0];
          }
          throw RangeError("Wrong time signature " + a + (typeof b == "undefined" ? "" : "/" + b));
        }
      };
      var _helperGNX = {
        umpMetadata: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 0, t);
        },
        umpProjectName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 1, t);
        },
        umpCompositionName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 2, t);
        },
        umpClipName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 3, t);
        },
        umpCopyright: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 4, t);
        },
        umpComposerName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 5, t);
        },
        umpLyricistName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 6, t);
        },
        umpArrangerName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 7, t);
        },
        umpPublisherName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 8, t);
        },
        umpPerformerName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 9, t);
        },
        umpAccPerformerName: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 10, t);
        },
        umpRecordingDate: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 11, t);
        },
        umpRecordingLocation: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 1, 12, t);
        },
        umpText: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 2, 0, t);
        },
        umpLyrics: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 2, 1, t);
        },
        umpLyricsLanguage: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 2, 2, t);
        },
        umpRuby: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 2, 3, t);
        },
        umpRubyLanguage: function(g, t) {
          return _helperGCX.umpCustomText(g, 0, 1, 2, 4, t);
        },
        umpData: function(g, x, y) {
          ...
          for (i2 = 0; i2 < a.length; i2++) a[i2] = [80 + _4b(g), _umpseqstat(a.length, i2) * 16 + a[i2].length, _8b(x)].concat(a[i2], _zeros).slice(0, 16);
          return a;
        }
      };
      var _noctrl = [0, 6, 32, 38, 98, 99, 100, 101];
      var _helperGC = {
        umpNoteOn: function(g, c, n2, v, t, a) {
          if (typeof v == "undefined") v = 65535;
          t = t || 0;
          a = a || 0;
          v = _16b(v);
          a = _16b(a);
          return [64 + _4b(g), 144 + _ch(c), _7bn(n2), _8b(t), v >> 8, v & 255, a >> 8, a & 255];
        },
        umpNoteOff: function(g, c, n2, v, t, a) {
          v = v || 0;
          t = t || 0;
          a = a || 0;
          v = _16b(v);
          a = _16b(a);
          return [64 + _4b(g), 128 + _ch(c), _7bn(n2), _8b(t), v >> 8, v & 255, a >> 8, a & 255];
        },
        umpAftertouch: function(g, c, n2, x, y, z, w) {
          return [64 + _4b(g), 160 + _ch(c), _7bn(n2), 0].concat(_32a(x, y, z, w));
        },
        umpAftertouchF: function(g, c, n2, x) {
          return _helperGC.umpAftertouch(g, c, n2, _f_32(x));
        },
        umpControl: function(g, c, n2, x, y, z, w) {
          if (_noctrl.includes(n2)) _throw(n2);
          return [64 + _4b(g), 176 + _ch(c), _7b(n2), 0].concat(_32a(x, y, z, w));
        },
        umpPortamento: function(g, c, n2) {
          return [64 + _4b(g), 176 + _ch(c), 84, 0, _7bn(n2), 0, 0, 0];
        },
        umpPressure: function(g, c, x, y, z, w) {
          return [64 + _4b(g), 208 + _ch(c), 0, 0].concat(_32a(x, y, z, w));
        },
        umpPressureF: function(g, c, x) {
          return _helperGC.umpPressure(g, c, _f_32(x));
        },
        umpProgram: function(g, c, n2, msb, lsb) {
          return typeof msb == "undefined" && typeof lsb == "undefined" ? [64 + _4b(g), 192 + _ch(c), 0, 0, _7bn(n2), 0, 0, 0] : [64 + _4b(g), 192 + _ch(c), 0, 1, _7bn(n2), 0, _7bn(msb), _7bn(lsb)];
        },
        umpPitchBend: function(g, c, x, y, z, w) {
          return [64 + _4b(g), 224 + _ch(c), 0, 0].concat(_32a(x, y, z, w));
        },
        umpPitchBendF: function(g, c, x) {
          return _helperGC.umpPitchBend(g, c, _f_32((x + 1) / 2));
        },
        umpPnPitchBend: function(g, c, n2, x, y, z, w) {
          return [64 + _4b(g), 96 + _ch(c), _7bn(n2), 0].concat(_32a(x, y, z, w));
        },
        umpPnPitchBendF: function(g, c, n2, x) {
          return _helperGC.umpPnPitchBend(g, c, n2, _f_32((x + 1) / 2));
        },
        umpRPN: function(g, c, b, n2, x, y, z, w) {
          return [64 + _4b(g), 32 + _ch(c), _7b(b), _7b(n2)].concat(_32a(x, y, z, w));
        },
        umpNRPN: function(g, c, b, n2, x, y, z, w) {
          return [64 + _4b(g), 48 + _ch(c), _7b(b), _7b(n2)].concat(_32a(x, y, z, w));
        },
        umpPnRPN: function(g, c, n2, i2, x, y, z, w) {
          return [64 + _4b(g), 0 + _ch(c), _7bn(n2), _8b(i2)].concat(_32a(x, y, z, w));
        },
        umpPnNRPN: function(g, c, n2, i2, x, y, z, w) {
          return [64 + _4b(g), 16 + _ch(c), _7bn(n2), _8b(i2)].concat(_32a(x, y, z, w));
        },
        ...
        umpCoarseTuning: function(g, c, n2) {
          return [64 + _4b(g), 32 + _ch(c), 0, 2, _7b(n2) * 2, 0, 0, 0];
        },
        umpCoarseTuningF: function(g, c, x) {
          return _helperGC.umpCoarseTuning(g, c, 64 + (x - x % 1));
        },
        umpTuningProgram: function(g, c, n2) {
          return [64 + _4b(g), 32 + _ch(c), 0, 3, _7b(n2) * 2, 0, 0, 0];
        },
        umpTuningBank: function(g, c, n2) {
          return [64 + _4b(g), 32 + _ch(c), 0, 4, _7b(n2) * 2, 0, 0, 0];
        },
        umpPnManagement: function(g, c, n2, m2) {
          var a = m2.toString().split("");
          var x = 0;
          for (var i2 = 0; i2 < a.length; i2++) {
            if (a[i2] == "S" && !(x & 1)) x |= 1;
            else if (a[i2] == "D" && !(x & 2)) x |= 2;
            else {
              x = m2;
              break;
            }
          }
          return [64 + _4b(g), 240 + _ch(c), _7bn(n2), _8b(x), 0, 0, 0, 0];
        }
      };
      ...
      var _helperGCX = {
        umpTuningF: function(g, c, x) {
          return [_helperGC.umpCoarseTuningF(g, c, x), _helperGC.umpFineTuningF(g, c, x)];
        },
        umpTuningA: function(g, c, a) {
          return _helperGCX.umpTuningF(g, c, MIDI.shift(a));
        },
        umpCustomText: function(g, c, d, b, s, t) {
          var i2;
          var a = [];
          t = JZZ.lib.toUTF8("" + t);
          for (i2 = 0; i2 < t.length; i2++) a.push(t.charCodeAt(i2));
          a = _slice(a, 12);
          for (i2 = 0; i2 < a.length; i2++) a[i2] = [208 + _4b(g), _umpseqstat(a.length, i2) * 64 + (d ? 16 : 0) + _ch(c), b, s].concat(a[i2], _zeros).slice(0, 16);
          return a;
        },
        umpCMetadata: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 0, t);
        },
        umpCProjectName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 1, t);
        },
        umpCCompositionName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 2, t);
        },
        umpCClipName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 3, t);
        },
        umpCCopyright: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 4, t);
        },
        umpCComposerName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 5, t);
        },
        umpCLyricistName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 6, t);
        },
        umpCArrangerName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 7, t);
        },
        umpCPublisherName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 8, t);
        },
        umpCPerformerName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 9, t);
        },
        umpCAccPerformerName: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 10, t);
        },
        umpCRecordingDate: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 11, t);
        },
        umpCRecordingLocation: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 1, 12, t);
        },
        umpCText: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 2, 0, t);
        },
        umpCLyrics: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 2, 1, t);
        },
        umpCLyricsLanguage: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 2, 2, t);
        },
        umpCRuby: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 2, 3, t);
        },
        umpCRubyLanguage: function(g, c, t) {
          return _helperGCX.umpCustomText(g, c, 0, 2, 4, t);
        }
      };
      var _helpersUmp = {};
      ...
      function _copyHelperGNX(name, func) {
        UMP[name] = function() {
          ...
          for (var i2 = 0; i2 < a.length; i2++) a[i2] = new UMP(a[i2]);
          return a;
        };
        _helpersUmp[name] = function() {
          var args = Array.prototype.slice.call(arguments);
          if (typeof this._gr != "undefined") args = [this._gr].concat(args);
          var a = func.apply(this, args);
          for (var i2 = 0; i2 < a.length; i2++) this.send(a[i2]);
          return this;
        };
      }
      ...
      function _umpseqstat(n2, i2) {
        return n2 == 1 ? 0 : i2 == 0 ? 1 : i2 == n2 - 1 ? 3 : 2;
      }
      function _slice(m2, n2) {
        var a = [];
        for (var x = m2; x.length; x = x.slice(n2)) a.push(x.slice(0, n2));
        return a.length ? a : [[]];
      }
      function _sliceSX(gr, m2) {
        var a = _slice(m2.slice(1, m2.length - 1), 6);
        for (var i2 = 0; i2 < a.length; i2++) a[i2] = new UMP([48 + gr, _umpseqstat(a.length, i2) * 16 + a[i2].length].concat(a[i2], _zeros).slice(0, 8));
        return a;
      }
      function _bytes(s) {
        var i2;
        var a = [];
        if (typeof s == "string") for (i2 = 0; i2 < s.length; i2++) a.push(s.charCodeAt(i2));
        else for (i2 = 0; i2 < s.length; i2++) a.push(s[i2]);
        for (i2 = 0; i2 < a.length; i2++) if (a[i2] != parseInt(a[i2]) || a[i2] < 0 || a[i2] > 255) throw RangeError("Bad data");
        return a;
      }
      ...
      function _copyHelperSXX(name, func) {
        UMP[name] = function() {
          var args = Array.prototype.slice.call(arguments);
          if (typeof this._gr != "undefined") args = [this._gr].concat(args);
          var m2 = func.apply(this, args.slice(1));
          var a = [];
          for (var i2 = 0; i2 < m2.length; i2++) a = a.concat(_sliceSX(_4b(args[0]), m2[i2]));
          return a;
        };
        _helpersUmp[name] = function() {
          var args = Array.prototype.slice.call(arguments);
          ...
          for (var i2 = 0; i2 < m2.length; i2++) {
            var a = _sliceSX(_4b(args[0]), m2[i2]);
            for (var j2 = 0; j2 < a.length; j2++) g = g.send(a[j2]);
          }
          return g;
        };
      }
      ...
      function _copyHelperM1CX(name, func) {
        UMP[name] = function() {
          ...
          for (var i2 = 0; i2 < a.length; i2++) a[i2] = new UMP([32 + _4b(args[0])].concat(a[i2], _zeros).slice(0, 4));
          return a;
        };
        _helpersUmp[name] = function() {
          var args = Array.prototype.slice.call(arguments);
          ...
          var a = func.apply(this, args.slice(1));
          var g = this;
          for (var i2 = 0; i2 < a.length; i2++) g = g.send([32 + _4b(args[0])].concat(a[i2], _zeros).slice(0, 4));
          return g;
        };
      }
      ...
      UMP.prototype._string = function() {
        ...
        if (t == 1 || t == 2) return new MIDI(this.slice(1))._string();
          ...
          n2 = this[1] >> 4;
          s = ["NOOP", "JR Clock", "JR Timestamp", "Ticks Per Quarter Note", "Delta Ticks"][n2];
        } else if (t == 3) {
          s = "SysEx";
        } else if (t == 4) {
          n2 = this[1] >> 4;
          ...
          if (n2 == 0) {
            ...
            if (n2 == 0) s += this.getBPM() + " BPM";
            else if (n2 == 1) s += this.getTimeSignature().join("/");
          } else if (n2 == 1) {
            n2 = this[3];
            s = {
              0: "Metadata",
        ...
        if (t == 15) {
          s = { 32: "Start of Clip", 33: "End of Clip" }[this[1]];
        }
        return s;
      };
      ...
      function _32_7(a, b, c, d) {
        var n2 = a * 16777216 + b * 65536 + c * 256 + d;
        return n2 >> 25 & 127;
      }
      function _grp(m2, g) {
        m2.gr = g;
      ...
      function _m2m1(msg) {
        if (msg.isMidi2) {
          ...
          if (t == 1 || t == 2) {
            ...
            n2 = msg[1] & 15;
            if (c == 0) {
              this._emit(_grp(new MIDI([240].concat(msg.slice(2, 2 + n2), [247])), g));
              this._sx[g] = void 0;
            } else if (c == 1) {
              this._sx[g] = msg.slice(2, 2 + n2);
            } else if (c == 2) {
              if (this._sx[g]) this._sx[g] = this._sx[g].concat(msg.slice(2, 2 + n2));
            } else if (c == 3) {
              if (this._sx[g]) this._emit(_grp(new MIDI([240].concat(this._sx[g], msg.slice(2, 2 + n2), [247])), g));
              this._sx[g] = void 0;
            }
          } else if (t == 4) {
            n2 = msg[1] >> 4;
            c = msg[1] & 15;
            if (n2 == 2 || n2 == 3) {
              this._emit(_grp(new MIDI([176 + c, n2 == 2 ? 101 : 99, msg[2]]), g));
              this._emit(_grp(new MIDI([176 + c, n2 == 2 ? 100 : 98, msg[3]]), g));
              this._emit(_grp(new MIDI([176 + c, 6, msg[4] >> 1]), g));
              this._emit(_grp(new MIDI([176 + c, 38, (msg[4] & 1) * 64 + (msg[4] >> 2)]), g));
            } else if (n2 == 8 || n2 == 9) {
            ...
            if (n2 == 14) {
              x = msg[4] * 16777216 + msg[5] * 65536 + msg[6] * 256 + msg[4] >> 18;
              this._emit(_grp(new MIDI([msg[1], x & 127, x >> 7 & 127]), g));
            } else if (n2 == 12) {
              if (msg[3]) {
                this._emit(_grp(new MIDI([176 + c, 0, msg[6]]), g));
                this._emit(_grp(new MIDI([176 + c, 32, msg[7]]), g));
              }
      ...
      function _m1m2(msg) {
        if (!msg.isMidi2) {
          ...
          if (msg[0] >= 128 && msg[0] < 240) {
            this._emit(JZZ.MIDI2([32 + gr].concat(msg.slice(), _zeros).slice(0, 4)));
          } else if (msg[0] > 240 && msg[0] <= 255 && msg[0] != 247) {
            this._emit(JZZ.MIDI2([16 + gr].concat(msg.slice(), _zeros).slice(0, 4)));
          } else if (msg.isFullSysEx()) {
            var a = _sliceSX(gr, msg.slice());
            for (var i2 = 0; i2 < a.length; i2++) this._emit(JZZ.MIDI2(a[i2]));
          }
        } else this._emit(msg);
      }
      function M1M2() {
      ...
      try {
        ...
        var _sch_tick = function() {
          ...
          for (var i2 = 0; i2 < n2; i2++) _sch_list.shift()();
          _sch_count++;
      ...
      JZZ.lib.registerMidiOut = function(name, engine) {
        ...
        for (var i2 = 0; i2 < _virtual._outs.length; i2++) if (_virtual._outs[i2].name == x.name) return false;
        x.engine = engine;
      ...
      JZZ.lib.registerMidiIn = function(name, engine) {
        var x = engine._info(name);
        for (var i2 = 0; i2 < _virtual._ins.length; i2++) if (_virtual._ins[i2].name == x.name) return false;
        x.engine = engine;
      ...
      JZZ.lib.closeAudioContext = function() {
        if (_ac) _ac.close();
        _ac = void 0;
      };
      ...
      JZZ.lib.fromUTF8 = function(data) {
        ...
        for (i2 = 0; i2 < data.length; i2++) {
          ...
          if (n2 < 128) out += data[i2];
          else if ((n2 & 224) == 192) {
            n2 = (n2 & 31) << 6;
            i2++;
            if (i2 >= data.length) return data;
            m2 = data.charCodeAt(i2);
            if ((m2 & 192) != 128) return data;
            n2 += m2 & 63;
      ...
      function _split(q) {
        var i2, k2;
        while (q.length) {
          for (i2 = 0; i2 < q.length; i2++) if (q[i2] == parseInt(q[i2]) && q[i2] >= 128 && q[i2] <= 255 && q[i2] != 247) break;
          q.splice(0, i2);
          if (!q.length) return;
          if (q[0] == 240) {
            for (i2 = 1; i2 < q.length; i2++) if (q[i2] == 247) break;
            if (i2 == q.length) return;
            return q.splice(0, i2 + 1);
          } else {
            k2 = _datalen(q[0]) + 1;
            if (k2 > q.length) return;
            for (i2 = 1; i2 < k2; i2++) if (q[i2] != parseInt(q[i2]) || q[i2] < 0 || q[i2] >= 128) break;
            if (i2 == k2) return q.splice(0, i2);
            else q.splice(0, i2);
          }
        }
      }
          ...
          if (self.proxy || !self.connected) resolve();
            ...
            if (self.pending.length == 1) {
              JZZ().openMidiIn(self.name).or(function() {
                for (i2 = 0; i2 < self.pending.length; i2++) self.pending[i2][1]();
                self.pending = [];
              }).and(function() {
                self.proxy = this;
                self.proxy.connect(self.onmidi);
                for (i2 = 0; i2 < self.pending.length; i2++) self.pending[i2][0]();
                self.pending = [];
              });
            }
          }
      ...
      _InputProxy.prototype.close = function() {
        var i2;
        if (this.proxy) {
          for (i2 = 0; i2 < this.ports.length; i2++) if (this.ports[i2].connection == "open") return;
          this.proxy.close();
          this.proxy = void 0;
        }
      };
      ...
      _InputProxy.prototype.reconnect = function() {
        ...
        for (i2 = 0; i2 < _wma.length; i2++) {
          ...
          if (p.connection == "closed") _statechange(p, _wma[i2]);
          else a.push([p, _wma[i2]]);
        }
        if (a.length) {
          JZZ()._openMidiInNR(self.name).or(function() {
            for (i2 = 0; i2 < a.length; i2++) a[i2][0].close();
          }).and(function() {
            self.proxy = this;
            self.proxy.connect(self.onmidi);
            for (i2 = 0; i2 < a.length; i2++) _statechange(a[i2][0], a[i2][1]);
          });
        }
      };
      function _datalen(x) {
        if (x >= 128 && x <= 191 || x >= 224 && x <= 239 || x == 242) return 2;
        if (x >= 192 && x <= 223 || x == 241 || x == 243) return 1;
        return 0;
      }
      ...
      function _validate(arr, sysex) {
        ...
        var data = [];
        for (i2 = 0; i2 < arr.length; i2++) {
          if (arr[i2] != parseInt(arr[i2]) || arr[i2] < 0 || arr[i2] > 255) throw TypeError(_epr + arr[i2] + " is not a UInt8 value.");
        }
        k2 = 0;
        for (i2 = 0; i2 < arr.length; i2++) {
          if (!k2) {
            if (arr[i2] < 128) throw TypeError(_epr + "Running status is not allowed at index " + i2 + " (" + arr[i2] + ").");
            if (arr[i2] == 247) throw TypeError(_epr + "Unexpected end of system exclusive message at index " + i2 + " (" + arr[i2] + ").");
            msg = [arr[i2]];
            data.push(msg);
            if (arr[i2] == 240) {
              if (!sysex) throw new DOMException("InvalidAccessError", _epr + "System exclusive messag is not allowed at index " + i2 + " (" + arr[i2] + ").", 15);
              k2 = -1;
            ...
            if (arr[i2] > 127) throw TypeError(_epr + "Unexpected status byte at index " + i2 + " (" + arr[i2] + ").");
            msg.push(arr[i2]);
            k2--;
          }
        }
        if (k2) throw TypeError(_epr + "Message is incomplete");
        return [data];
      }
      ...
      function _Maplike(data) {
        ...
        this.keys = function() {
          try {
            ...
            for (var id in data) if (this.has(id)) m2.set(id, this.get(id));
            return m2.keys();
          } catch (e) {
          }
        };
      ...
      function _wm_watch(x) {
        ...
        for (i2 = 0; i2 < x.inputs.removed.length; i2++) {
          ...
          if (_inputMap.hasOwnProperty(p.id)) {
            a = [];
            for (k2 = 0; k2 < _wma.length; k2++) a.push([_wma[k2].inputs.get(p.id), _wma[k2]]);
            _inputMap[p.id].disconnect();
            for (k2 = 0; k2 < a.length; k2++) _statechange(a[k2][0], a[k2][1]);
          }
        }
        for (i2 = 0; i2 < x.outputs.removed.length; i2++) {
          ...
          if (_outputMap.hasOwnProperty(p.id)) {
            a = [];
            for (k2 = 0; k2 < _wma.length; k2++) a.push([_wma[k2].outputs.get(p.id), _wma[k2]]);
